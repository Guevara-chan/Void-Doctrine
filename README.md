...
❗ OpenSSL [libraries](https://github.com/Guevara-chan/Void-Doctrine/releases/tag/lib) (already provided with Nim installation) needs to be placed in same dir with pre-compiler binaries. ❗
