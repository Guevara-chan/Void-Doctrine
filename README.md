...
__Latest version:__ https://github.com/Guevara-chan/Void-Doctrine/releases/download/0.13/Void.Doctrine.zip (direct link)  
...
# •Reassembling•
__Void°Doctrine__ has been entirelly made for [Nim 0.20.0](https://nim-lang.org) and external [VkApi](https://github.com/vk-brain/nimvkapi) package by VK Brain.  
