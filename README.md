...
❗ [OpenSSL](https://github.com/Guevara-chan/Void-Doctrine/releases/tag/lib) libraries (already provided with Nim installation) needs to be placed together with pre-compiler binaries. ❗
